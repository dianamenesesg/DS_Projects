...
## Plots the simulated path, conditional standard deviations and residuals.
...
############################################################################
############### Fit an ARMA-GARCH model to the (simulated) data ############
...
## Plot data X_t and fitted hat{mu}_t and consider some sanity checks.
...
#############################################################################
####  Simulate future trajectories of (Xt) and compute corresponding VaRs ###
# Simulate paths, estimate VaR for each simulated path 
# (note that quantile() can't be used here so we have to construct VaR manually) 
# and compute bootstrapped confidence intervals for VaR??.
